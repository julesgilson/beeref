...
from beeref.logging_beeref import (
    BeeLogger,
...
@patch('beeref.logging_beeref.BeeLogger.log')
...
@patch('beeref.logging_beeref.qtlogger.info')
...
@patch('beeref.logging_beeref.qtlogger.warning')
